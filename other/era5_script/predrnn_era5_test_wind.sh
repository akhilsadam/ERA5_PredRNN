...
python -u run1.py \
    ...
    --save_dir /scratch/08589/hvtran/predrnn-pytorch/checkpoints/2012_predrnn_test_wind \
    --gen_frm_dir /scratch/08589/hvtran/predrnn-pytorch/checkpoints/2012_predrnn_test_wind \
