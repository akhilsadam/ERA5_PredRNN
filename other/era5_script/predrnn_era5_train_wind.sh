...
python -u run1.py \
    ...
    --save_dir /work/09012/haoli1/ls6/ERA5/predrnn-pytorch/checkpoints/era5_predrnn_wind \
    --gen_frm_dir /work/09012/haoli1/ls6/ERA5/predrnn-pytorch/checkpoints/era5_predrnn_wind \
    ...
    # --pretrained_model /work/09012/haoli1/ls6/ERA5/model.ckpt-best-wind
