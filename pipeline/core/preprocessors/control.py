...
class Preprocessor(PreprocessorBase):
    def __init__(self, config):
        ...
        self.patch_x = config['shapex'] # height
        self.patch_y = config['shapey'] # width
    ...
    def load(self, device):
        ...
        self.batched_input_transform = lambda x: in_tf(x)
        self.batched_output_transform = lambda a: out_tf(a)