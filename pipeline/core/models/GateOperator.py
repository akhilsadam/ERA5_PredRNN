...
from core.operators.LocalPODwAttDMDOperator import Operator
# from core.layers.Siren import MLP
from core.loss import loss_mixed

class GateOperator(BaseModel):
    def __init__(self, num_layers, num_hidden, configs):
        ...
        # limited spatial to 1 (nonexistent)
        
        self.operator = Operator(self.in_channel, 1, self.input_length, device=self.device, nlayers=1, h = self.height, w = self.width)
