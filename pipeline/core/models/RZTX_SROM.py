...
class RZTX(BaseModel):
    ...
    def __init__(self, num_layers, num_hidden, configs):
        ...
        self.siren_dim = self.model_args['siren_dim']
        self.n_siren_layers = self.model_args['n_siren_layers']
        self.n_siren_embd = self.model_args['n_siren_embd']
        self.sfreq = self.model_args['siren_freq']
        
        # mode size is self.total_length*channels*shapex*shapey
