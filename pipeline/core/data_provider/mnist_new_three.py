...
class InputHandle:
    ...
    def load_idv(self, a,b):
        ...
        return self.refs[data_index]['input_raw_data'][begin:end,self.img_layers,:,:], data_index
    ...
    def input_batch_f(self):
        ...
        for i in range(self.current_batch_size):
            ...
            self.input_batch[i, :self.total_length, :, :, :], self.cdi = self.load_idv(begin, end)
    ...
    def clear_refs(self):       
        del self.refs[cdi]
        gc.collect()
        self.refs[cdi] = np.load(self.paths[cdi], mmap_mode='r')
